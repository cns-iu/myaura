...
if __name__ == '__main__':
    ...
    rCSVfile1 = '../../instagram/tmp-data/02-instagram-epilepsy-comentions-{dicttimestamp:s}-samepost.csv.gz'.format(dicttimestamp=dicttimestamp1)
    rCSVfile2 = '../../instagram/tmp-data/02-instagram-epilepsy-comentions-{dicttimestamp:s}-samepost.csv.gz'.format(dicttimestamp=dicttimestamp2)
    network_name1 = 'Network (Instagram : Epilepsy : {dicttimestamp:s})'.format(dicttimestamp=dicttimestamp1)
    network_name2 = 'Network (Instagram : Epilepsy : {dicttimestamp:s})'.format(dicttimestamp=dicttimestamp2)
    ...
    wGfile1 = 'tmp-data/04-instagram-epilepsy-network-{dicttimestamp:s}-samepost'.format(dicttimestamp=dicttimestamp1)
    wGfile2 = 'tmp-data/04-instagram-epilepsy-network-{dicttimestamp:s}-samepost'.format(dicttimestamp=dicttimestamp2)
