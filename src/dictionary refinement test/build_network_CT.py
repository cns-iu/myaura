...
if __name__ == '__main__':
    ...
    comention_table1 = 'mention_clinical_trials_%s.comention' % (dicttimestamp1)
    comention_table2 = 'mention_clinical_trials_%s.comention' % (dicttimestamp2)
    ...
    wGfile1 = 'tmp-data/ct-epilepsy-network-{dicttimestamp:s}'.format(dicttimestamp=dicttimestamp1)
    wGfile2 = 'tmp-data/ct-epilepsy-network-{dicttimestamp:s}'.format(dicttimestamp=dicttimestamp2)
