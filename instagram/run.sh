...
sed -i "s/$OLD_DICT_VERSION/$DICT_VERSION/" src/01-parse_instagram_mentions.py
...
python src/01-parse_instagram_mentions.py
...
sed -i "s/$DICT_VERSION/$OLD_DICT_VERSION/" src/01-parse_instagram_mentions.py
