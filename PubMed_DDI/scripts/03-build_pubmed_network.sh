...
for EVIDENCE in invivo, invitro, clinical;
do
#
# Init variables
#
SCHEMA=net_pubmed_ddi_${EVIDENCE}_$DICT_VERSION
CSVNODES=tmp-data/04-pubmed-ddi-$EVIDENCE-network-$DICT_VERSION-nodes.csv
CSVEDGES=tmp-data/04-pubmed-ddi-$EVIDENCE-network-$DICT_VERSION-edges.csv
