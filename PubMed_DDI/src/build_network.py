...
if __name__ == '__main__':
    ...
    for evidence in ['invivo', 'invitro', 'clinical']:
        comention_table = 'mention_pubmed_ddi_%s_%s.comention' % (evidence, dicttimestamp)
        ...
        print('--- Exporting ---')
        # Graph gormat
        wGfile = 'tmp-data/04-pubmed-ddi-{evidence:s}-network-{dicttimestamp:s}'.format(evidence=evidence,
