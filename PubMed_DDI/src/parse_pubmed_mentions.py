...
if __name__ == '__main__':
    ...
    for evidence in ['invivo', 'invitro', 'clinical']:
        mention_table = 'mention_pubmed_ddi_%s_%s.mention' % (evidence, dicttimestamp)
        for i in range(10000):
            ...
            # SQL Query
            sql = """SELECT pmid, article_title, abstract_text, pub_year FROM pubmed_ddi_classification.view_text_%s offset %d limit 100""" % (
            evidence, offset)
