...
if __name__ == '__main__':
    ...
    #
    rCSVfile = '../tmp-data/02-efwebsite-forums-comentions-{dicttimestamp:s}-samepost.csv.gz'.format(dicttimestamp=dicttimestamp)
    ...
    print('--- Exporting ---')
    # Graph gormat
    wGfile = '../tmp-data/04-efwebsite-forums-network-{dicttimestamp:s}-samepost'.format(dicttimestamp=dicttimestamp)
    print('> gpickle')
