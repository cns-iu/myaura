...
if __name__ == '__main__':
    drop_set = set([240710, 146507, 25536, 8593, 182630, 8619, 240925, 188818, 16726, 8582, 206783, 8628])
    #
    # Init
    #
    ...
    for idx, row in df.iterrows():
        ...
        for source, target in combinations(row['matches'], 2):
            ...
            if source['id_parent'] == target['id_parent']:
                continue
            if source['id'] in drop_set or target['id'] in drop_set:
                continue
    ...
    records = [(s.term_id_parent, s.parent, s.type, t.term_id_parent, t.parent, t.type, c) for (s, t), c in counter.items()]
